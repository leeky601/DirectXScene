...
bool TextClass::SetMousePosition(int mouseX, int mouseY, int faceCount, ID3D11DeviceContext* deviceContext)
{
	...
	result = UpdateSentence(m_sentence3, pollygonString, 20, 60, 1.0f, 0.0f, 0.0f, deviceContext);
	...
	result = UpdateSentence(m_sentence4, mouseString, 20, 80, 1.0f, 0.0f, 0.0f, deviceContext);

	strcpy_s(mouseString, "Num of objects = 307");
